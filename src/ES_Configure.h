...
#define SERV_0_HEADER "ClutchSM.h"
// the name of the Init function
#define SERV_0_INIT InitClutchSM
// the name of the run function
#define SERV_0_RUN RunClutchSM
...
#define EVENT_CHECK_LIST    CheckSerial            // nothing here for now -- could add in keystroke tester later 
// CheckBluetooth, CheckLight, CheckBluetoothConnection
//CheckMode, 
/****************************************************************************/
...
#define TIMER0_RESP_FUNC PostClutchSM
